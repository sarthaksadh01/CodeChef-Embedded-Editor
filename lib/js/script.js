...
let statusImgs = {
  compile: { url: "https://www.codechef.com/misc/alert-icon.gif", message: "Compilation Error" },
  wrong: {
    url: "https://www.codechef.com/misc/cross-icon.gif", message: "Wrong Answer"
  },
  time: { url: "https://www.codechef.com/misc/clock_error.png", message: "Time Limit Exceeded" },
  partial_accepted:
    { url: "https://www.codechef.com/sites/all/modules/codechef_tags/images/partially-solved.png", message:"Partially Accepted" },
  accepted: { url: "https://www.codechef.com/misc/tick-icon.gif", message: "All Correct" },
  runtime: { url: "https://www.codechef.com/misc/runtime-error.png", message: "Runtime Error" },
};
...
function setStats(res) {
  ...
  if (res.signal && res.signal!=undefined && res.signal != 15 && res.signal!=0) {

    $("#signalDiv").show();
    if(Number.isInteger(res.signal))
      document.querySelector("#signal").innerHTML = signal_table[res.signal];
    else
      document.querySelector("#signal").innerHTML = res.signal;
