...
let statusImgs = {
  compile: "https://www.codechef.com/misc/alert-icon.gif",
  wrong: "https://www.codechef.com/misc/cross-icon.gif",
  time: "https://www.codechef.com/misc/clock_error.png",
  partial_accepted:
    "https://www.codechef.com/sites/all/modules/codechef_tags/images/partially-solved.png",
  accepted: "https://www.codechef.com/misc/tick-icon.gif",
  runtime: "https://www.codechef.com/misc/runtime-error.png",
};
      ...
      function (response) {
        ...
        if (response.status=="error") {
          ...
          document.querySelector("#statusImgs").src =
            statusImgs[response.status.result_code];
